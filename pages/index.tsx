...
export default function Home() {
  return (
    <div className="flex-auto text-center container mx-auto max-w-fit bg-black min-w-full min-h-screen p-4 px-6 py-4">
      <div className="mx-auto border-[2.5px] border-l-teal-400 border-t-emerald-500 border-r-cyan-400 border-b-sky-400 rounded-xl text-center min-h-screen p-4 py-3">
